...
namespace CuEVM {
__device__ cached_evm_call_state::cached_evm_call_state(evm_call_state_t* state) {  // copy from state to cache
    pc = state->pc;
...
__device__ void cached_evm_call_state::set_byte_code(const byte_array_t* byte_code) {
 ...
 */
__device__ evm_call_state_t::evm_call_state_t(CuEVM::evm_call_state_t* parent,
...
__device__ evm_call_state_t::evm_call_state_t(CuEVM::evm_call_state_t* other) {
 ...
 */
__device__ evm_call_state_t::~evm_call_state_t() {
    if (parent != nullptr) {
...
__device__ void evm_call_state_t::print() const {
...
__device__ int32_t evm_call_state_t::update(evm_call_state_t& other) {
