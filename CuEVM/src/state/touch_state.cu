...
namespace CuEVM {
__host__ __device__ int32_t TouchState::add_account(ArithEnv &arith, const bn_t &address,
...
__host__ __device__ int32_t TouchState::get_account(ArithEnv &arith, const bn_t &address,
                                                    CuEVM::account_t *&account_ptr,
                                                    const CuEVM::account_flags_t acces_state_flag,
...
__host__ __device__ int32_t TouchState::poke_account(ArithEnv &arith, const bn_t &address,
...
__host__ __device__ int32_t TouchState::get_account_index(ArithEnv &arith, const bn_t &address, uint32_t &index) const {
    index = 0;
...
__host__ __device__ int32_t TouchState::get_code(ArithEnv &arith, const bn_t &address, byte_array_t &byte_code) {
    account_t *account_ptr = nullptr;
...
__host__ __device__ int32_t TouchState::poke_value(ArithEnv &arith, const bn_t &address, const bn_t &key,
                                                   bn_t &value) const {
    account_t *account_ptr = nullptr;
    const TouchState *tmp = this;
    while (tmp != nullptr) {
...
__host__ __device__ int32_t TouchState::poke_original_value(ArithEnv &arith, const bn_t &address, const bn_t &key,
                                                            bn_t &value) const {
    return _world_state->get_value(arith, address, key, value);
}

__host__ __device__ int32_t TouchState::poke_balance(ArithEnv &arith, const bn_t &address, bn_t &balance) const {
    account_t *account_ptr = nullptr;
    const TouchState *tmp = this;
...
__host__ __device__ bool TouchState::is_warm_account(ArithEnv &arith, const bn_t &address) const {
    account_t *account_ptr = nullptr;
    return (poke_account(arith, address, account_ptr) == ERROR_SUCCESS);
}

__host__ __device__ bool TouchState::is_warm_key(ArithEnv &arith, const bn_t &address, const bn_t &key) const {
    account_t *account_ptr = nullptr;
    bn_t value;
    const TouchState *tmp = this;
    while (tmp != nullptr) {
...
__host__ __device__ bool TouchState::set_warm_account(ArithEnv &arith, const bn_t &address) {
    account_t *account_ptr = nullptr;
    if (poke_account(arith, address, account_ptr)) {
        add_account(arith, address, account_ptr, ACCOUNT_BALANCE_FLAG);
    }
}
__host__ __device__ bool TouchState::set_warm_key(ArithEnv &arith, const bn_t &address, const bn_t &key,
                                                  const bn_t &value) {
    account_t *account_ptr = nullptr;
...
__host__ __device__ int32_t TouchState::set_balance(ArithEnv &arith, const bn_t &address, const bn_t &balance) {
    account_t *account_ptr = nullptr;
...
__host__ __device__ int32_t TouchState::set_nonce(ArithEnv &arith, const bn_t &address, const bn_t &nonce) {
    account_t *account_ptr = nullptr;
...
__host__ __device__ int32_t TouchState::set_code(ArithEnv &arith, const bn_t &address, const byte_array_t &byte_code) {
    account_t *account_ptr = nullptr;
...
__host__ __device__ int32_t TouchState::set_storage_value(ArithEnv &arith, const bn_t &address, const bn_t &key,
                                                          const bn_t &value) {
    account_t *account_ptr = nullptr;
    _world_state->get_account(arith, address, account_ptr);
...
__host__ __device__ bool TouchState::is_empty_account(ArithEnv &arith, const bn_t &address) {
    account_t *account_ptr = nullptr;
...
__host__ __device__ bool TouchState::is_empty_account_create(ArithEnv &arith, const bn_t &address) {
    account_t *account_ptr = nullptr;
    poke_account(arith, address, account_ptr, true);
...
__host__ __device__ int32_t TouchState::is_deleted_account(ArithEnv &arith, const bn_t &address) {
    return ERROR_SUCCESS;
}
...
__host__ __device__ int32_t TouchState::transfer(ArithEnv &arith, const bn_t &from, const bn_t &to, const bn_t &value) {
