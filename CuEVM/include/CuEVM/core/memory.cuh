...
struct evm_memory_t {
     ...
     * @return 0 if success, otherwise the error code.
     */
    __host__ __device__ int32_t get(const uint32_t index, const uint32_t length, uint8_t *&data_);
     ...
     * @return 0 if success, otherwise the error code.
     */
    __host__ __device__ int32_t copy(const uint32_t index, const uint32_t length, uint8_t *&data_);
