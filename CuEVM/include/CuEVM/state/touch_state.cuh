...
class TouchState {
   ...
   public:
    ...
    __host__ __device__ int32_t get_account_index(const evm_word_t *address, uint32_t &index) const;
    /**
     * If the account given by address is empty
     * @param[in] address The address of the account.
     * @return true if the account is empty, false otherwise.
     */
    __host__ __device__ bool is_empty_account(const evm_word_t *address);
     ...
     * @return __host__
     */
    __host__ __device__ bool is_empty_account_create(const evm_word_t *address);
     ...
     */
    __host__ __device__ int32_t is_deleted_account(const evm_word_t *address);
     ...
     */
    __host__ __device__ int32_t get_balance(const evm_word_t *address, evm_word_t &balance);
     ...
     * @return error_code, 0 if success
     */
    __host__ __device__ int32_t get_nonce(const evm_word_t *address, evm_word_t &nonce);
     ...
     * @return error_code, 0 if success
     */
    __host__ __device__ int32_t get_code(const evm_word_t *address, byte_array_t &byte_code);
    ...
    __host__ __device__ int32_t poke_original_value(const evm_word_t *address, const evm_word_t &key,
     ...
     */
    __host__ __device__ int32_t set_balance(const evm_word_t *address, const evm_word_t &balance);
     ...
     * @return 0 if the account is found, error otherwise.
     */
    __host__ __device__ int32_t poke_account(const evm_word_t *address, CuEVM::account_t *&account_ptr,
     ...
     */
    __host__ __device__ bool is_warm_account(const evm_word_t *address) const;
     ...
     */
    __host__ __device__ bool is_warm_key(const evm_word_t *address, const evm_word_t &key) const;

    /**
     * Set an account to be warm
     * @param address The address of the account.
     */
    __host__ __device__ bool set_warm_account(const evm_word_t *address);
     ...
     */
    __host__ __device__ bool set_warm_key(const evm_word_t *address, const evm_word_t &key, const evm_word_t &value);
    /**
     ...
     */
    __host__ __device__ int32_t set_nonce(const evm_word_t *address, const evm_word_t &nonce);
     ...
     */
    __host__ __device__ int32_t set_code(const evm_word_t *address, const byte_array_t &byte_code);
     ...
     */
    __host__ __device__ int32_t set_storage_value(const evm_word_t *address, const evm_word_t &key,
     ...
     */
    __host__ __device__ int32_t delete_account(const evm_word_t *address);
     ...
     */
    __host__ __device__ int32_t mark_for_deletion(const evm_word_t *address);
     ...
     */
    __host__ __device__ int32_t update(TouchState *other);

    // update the final state with the world state and combine storage
    __host__ __device__ int32_t update_world_state();
     ...
     */
    __host__ __device__ int32_t transfer(const evm_word_t *from, const evm_word_t *to, const evm_word_t &value);

    __host__ __device__ CuEVM::contract_storage_t get_entire_storage(const uint32_t account_index) const;
