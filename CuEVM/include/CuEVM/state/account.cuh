...
namespace CuEVM
{
    ...
    */
     ...
     */
    __host__ static account_t *get_cpu(
        uint32_t count);
     ...
     * @param[in] count The number of instances
     */
    __host__ static account_t *get_gpu_from_cpu(
        account_t *cpu_instances,
        uint32_t count);
     ...
     * @return The cpu data structures
     */
    __host__ static account_t *get_cpu_from_gpu(
        account_t *gpu_instances,
        uint32_t count);
    /**
     ...
     * @return The json object
     */
    __host__ static cJSON* merge_json(
     ...
     * @param[in] count The number of instances
     */
    __global__ void account_t_transfer_kernel(
