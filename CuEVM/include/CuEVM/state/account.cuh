...
struct account_t {
    ...
    /**
     * Verify if the account is empty for create operations.
     * @return If empty 1, otherwise 0
     */
    __host__ __device__ bool is_empty_create();
    ...
    /**
     * Generate the cpu data structures for the account from the gpu data
     * structures.
