...
namespace CuEVM {
    struct evm_instance_t {
        ...
        CuEVM::state_access_t *access_state_data_ptr; /**< The access state pointer*/
    ...
    struct evm_t {
        ...
        CuEVM::AccessState access_state; /**< The access state */
         ...
         * @param[in] access_state_data_ptr The access state pointer
