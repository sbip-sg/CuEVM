...
struct evm_call_state_t {
     ...
     */
    __host__ __device__ evm_call_state_t(CuEVM::evm_call_state_t* parent, uint32_t depth, uint32_t pc, gas_t gas_used,
                                         gas_t gas_refund, CuEVM::evm_message_call_t* message_ptr,
     ...
     */
    __host__ __device__ evm_call_state_t(CuEVM::evm_call_state_t* parent, CuEVM::evm_message_call_t* shared_message_ptr,
    ...
    __host__ __device__ evm_call_state_t(CuEVM::evm_call_state_t* other);
    /**
     * The constructor with no parent state and message call
     */
    __host__ __device__ evm_call_state_t(CuEVM::WorldState* word_state_ptr, CuEVM::evm_stack_t* stack_ptr,
...
struct cached_evm_call_state {
    ...
    __host__ __device__ cached_evm_call_state(evm_call_state_t* state);  // copy from state to cache
